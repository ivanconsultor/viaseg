    ...
    <main className="min-h-screen bg-slate-50 text-[#1A1A2E] flex flex-col">
      ...
      <section className="relative pt-40 pb-32 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6 text-center max-w-4xl pt-10">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="bg-black/30 p-8 rounded-3xl backdrop-blur-md border border-white/20 shadow-2xl">
            <span className="inline-block py-1.5 px-4 rounded-full bg-[#FF6B00] text-white font-bold tracking-wider uppercase text-sm mb-6 shadow-md">Seguro Auto</span>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              <h2 className="font-heading text-3xl font-bold mb-6 text-[#1A1A2E]">Tranquilidade no trânsito e na vida.</h2>
              ...
              <ul className="space-y-4 mb-10">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-800 font-medium">Assistência 24h em qualquer lugar do Brasil.</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="bg-[#FF6B00]/10 p-1.5 rounded-full mt-1 text-[#FF6B00]"><Heart size={18} /></div>
                  <span className="text-slate-800 font-medium">Cobertura completa para terceiros, cuidando de todos ao redor.</span>
                </li>
              </ul>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
              <img src="https://images.unsplash.com/photo-1511895426328-dc8714191300?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Mulher sorrindo no carro" className="rounded-2xl shadow-xl relative z-10 border border-slate-100" />
            </motion.div>
          </div>
        </div>
      </section>
